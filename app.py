...
with st.sidebar:
    ...
    st.write(
       "This demo predicts the risk that a patient will **not show up** to a scheduled "
       "medical appointment, using a logistic regression model trained on the "
       "Kaggle Medical Appointment No-Show dataset from Brazil."
